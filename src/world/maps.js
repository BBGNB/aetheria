...
export const MAPS = {
  ...
  reachDeep: {
    ...
    encounters: [
      ...
      { enemyIds: ['wraith'],                                         weight: 2 },
      { enemyIds: ['wraith', 'brambleSprite'],                        weight: 1 },
      ...
      { enemyIds: ['wraith', 'choirmoth', 'brambleSprite'],           weight: 1 },
      { enemyIds: ['wraith', 'wraith', 'brambleSprite'],              weight: 1 },
      ...
      { enemyIds: ['wraith','wraith','brambleSprite','choirmoth'],                               weight: 2, partyMin: 3 },
      ...
      { enemyIds: ['wraith','wraith','choirmoth','brambleSprite','brambleSprite','brambleSprite'], weight: 1, partyMin: 3 },
    ],
    encounterRate: 3.2,
    npcs: [],
    doors: [
